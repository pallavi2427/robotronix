...
import logoSlider from "./../../assets/img/force_logo_c1.png";
import logoSlider2 from "./../../assets/img/aictsl.png";
import logoSlider3 from "./../../assets/img/fr.png";
import logoSlider4 from "./../../assets/img/honda_logo.png";
import logoSlider5 from "./../../assets/img/pinnacle.png";
import logoSlider6 from "./../../assets/img/airport_authority_of_india.png";
import logoSlider7 from "./../../assets/img/mpidc_logo.png";
...
const Slider = () => {
  return (
      ...
      <main className="main">
        <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner">
            <div className="carousel-item active slider_one" data-bs-interval="2000">
        ...
        {/* /Hero Section */}
        {/* Logo section */}
        <section id="services" className="logo-section">
	...
	<div class="slide-track">
		<div class="slide">
			<img src={logoSlider} height="100" width="250" alt="" />
		</div>
		<div class="slide">
			<img src={logoSlider2} height="100" width="250" alt="" />
		</div>
		<div class="slide">
			<img src={logoSlider3} height="100" width="250" alt="" />
		</div>
		<div class="slide">
			<img src={logoSlider4} height="100" width="250" alt="" />
		</div>
    <div class="slide">
			<img src={logoSlider6} height="100" width="250" alt="" />
		</div>
		<div class="slide">
			<img src={logoSlider5} height="100" width="250" alt="" />
		</div>
		
		<div class="slide">
			<img src={logoSlider7} height="100" width="250" alt="" />
		</div>
		<div class="slide">
			<img src={logoSlider} height="100" width="250" alt="" />
		</div>
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="service-item">
                    ...
                    <div className="service-item-content">
                      ...
                      <p>
                        Gravida sodales condimentum pellen tesq accumsan orci
                        quam sagittis sapie
                      </p>
                    </div>
                  </div>
              ...
              <div className="row">
                ...
                >
                  ...
                  <p className="opacity-50">
                    ...
                    illum minima nostrum perspiciatis error consequatur sit
                    nulla.
                  </p>
          ...
          <div className="container">
            <div className="row gy-4 justify-content-between align-items-center">
              <div
                ...
                data-aos="zoom-out"
              >
                <img src={img_sq_1} alt="Image" className="img-fluid" />
                <a
                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide">
                    <div className="service-item">
                      ...
                      <img src={img_sq_3} alt="Image" className="img-fluid" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="service-item">
                      ...
                      <img src={img_sq_8} alt="Image" className="img-fluid" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="service-item">
                      ...
                      <img src={img_sq_4} alt="Image" className="img-fluid" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="service-item">
                      ...
                      <img src={img_sq_5} alt="Image" className="img-fluid" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="service-item">
                      ...
                      <img src={img_sq_6} alt="Image" className="img-fluid" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="service-item">
                  ...
                  <div className="testimonial">
                    ...
                    <blockquote>
                      <p>
                        ...
                        elit. Provident deleniti iusto molestias, dolore vel
                        fugiat ab placeat ea?”
                      </p>
                    </blockquote>
